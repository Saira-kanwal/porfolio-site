      ...
      return (
        ...
        (n._addTouchEventListeners = function () {
          ...
          if (this._touchSupported) {
            var n = function (e) {
                t._pointerEvent && x[e.originalEvent.pointerType.toUpperCase()]
              ...
              i = function (e) {
                t._pointerEvent &&
                  x[e.originalEvent.pointerType.toUpperCase()] &&
                ...
                for (var r = 0; r < o; r++) {
                  ...
                  null !== l &&
                    (e([].slice.call(document.querySelectorAll(l))).hasClass(
                      ...
                      e(s).addClass(X).attr("aria-expanded", !1));
                }
          ...
          a.forEach(function (t) {
            (function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === wt.indexOf(n) ||
                  Boolean(t.nodeValue.match(At) || t.nodeValue.match(Nt))
                );
              for (
          ...
          "object" != typeof n || (!n.nodeType && !n.jquery)
            ? this.config.html
              ? (this.config.sanitize &&
                  (n = Ot(n, this.config.whiteList, this.config.sanitizeFn)),
                t.html(n))
              : t.text(n)
            : this.config.html
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              ...
              (i || ((i = new t(this, o)), e(this).data(Pt, i)),
              "string" == typeof n)
            ) {
              if (void 0 === i[n])
                throw new TypeError('No method named "' + n + '"');
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            var i = e(this),
              o = i.data(ve);
            if (
              (o || ((o = new t(this)), i.data(ve, o)), "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
              o[n]();
      ...
      return (
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (o ||
                ((o = new t(this, "object" == typeof n && n)), i.data(we, o)),
              "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
